...
//	HALAMAN DEPAN MASTER USER
	...
	@FindBy(css = "#left-panel > nav > ul > li.open > ul > li:nth-child(1) > a")
	private WebElement masterUser;
...
//		txtSearchPopupOperation.sendKeys("joko");
//		btnPilihPopupOperation.click();
//		
//		btnPopupSales.click();
//		txtSearchPopupSales.sendKeys("joko");
